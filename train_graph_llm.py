...
# accelerator = Accelerator(config_file="/home/sphaire/gnn_llm/Graph-LLM/accelerate_config/my_config_0.yaml")
nodes = {
    '0': 'Home Page', '1': 'Bike Models Overview', '2': 'Specific Bike Model Page', 
    '3': 'Build & Customize', '4': 'Compare Models', '5': 'Find a Dealer', 
    '6': 'Request a Quote', '7': 'Check Financing Options', '8': 'Schedule a Test Ride', 
    '9': 'Customer Reviews', '10': 'Accessory Shop', '11': 'Service & Maintenance Info', 
    '12': 'User Account Login/Registration', '13': 'Contact Support', '14': 'Promotions & Offers', 
    '15': 'Blog/News/Updates', '16': 'Events & Community', '17': 'Bike Registration', 
    '18': 'Bike Insurance Information', '19': 'FAQ/Help Center'
}
...
def main(args, SEED):
    ...
    with accelerator.main_process_first():
        ...
        print('###################################################')
        print(f'edges tensor{edge_index}')
    ...
    # for c,i in enumerate(train_loader):
    #     print(i)
    #     if c == 4:
    #         break
    ...
    if accelerator.is_local_main_process:
        ...
        print(f'eval_label is {eval_label}')
        print(f'eval pred is {eval_pred}')
        for i, _ in enumerate(eval_pred):
            print(f'predicted label {nodes[_]} vs actual label {nodes[eval_label[i]]}')
        pred = [_ == f"{eval_label[i]}" for i, _ in enumerate(eval_pred)]
