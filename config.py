...
preprocess_original_dataset = {
    ...
    'sp': preprocess_function_original_sp_custom,
...
preprocess_train_dataset = {
    ...
    'sp': preprocess_function_generator_sp_custom,
...
preprocess_test_dataset = {
    ...
    'sp': preprocess_test_function_generator_sp_custom,
